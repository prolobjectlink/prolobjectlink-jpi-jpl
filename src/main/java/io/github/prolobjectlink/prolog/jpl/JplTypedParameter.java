...
public class JplTypedParameter extends JplParameter implements PrologTypedParameter {

	private final PrologTerm kind;

	JplTypedParameter(PrologProvider provider, PrologTerm name, PrologTerm kind) {
		super(provider, name);
		this.kind = kind;
	}
